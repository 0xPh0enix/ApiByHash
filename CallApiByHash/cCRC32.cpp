...
UINT cCRC32::Hash(LPSTR pszData, DWORD dwLenght) {

	UINT uiCRC32 = 0xFFFFFFFF;

	for (size_t i = 0; i < dwLenght; ++i)
		uiCRC32 = ((uiCRC32 >> 8) & 0x00FFFFFF) ^ uiCRC32Table[(uiCRC32 ^ (UINT)*pszData++) & 0xFF];
